...
{
    // Remove the WithDebounce trait

    public $timeRange = 'daily'; // daily, weekly, monthly, yearly

    // In Livewire v3, you can debounce using the #[Debounce(ms)] attribute
    // or by setting $debounce property

    protected $listeners = ['timeRangeChanged' => '$refresh'];

    // Add this for Livewire v3
    ...
    {
        $cacheKey = 'transjakarta_stats_'.Auth::id().'_'.$this->timeRange;
        ...
        return cache()->remember($cacheKey, now()->addMinutes(30), function() {
            ...
            // Gunakan database grouping untuk monthly dan yearly
