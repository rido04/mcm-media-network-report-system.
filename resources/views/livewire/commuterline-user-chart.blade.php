<div class="rounded-lg pt-10 shadow-lg mb-4">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
            ...
            <p class="text-gray-300 text-sm">
                Tracking impression data across different time periods
            </p>
        </div>

        <!-- Time Range Filter -->
        <div class="mt-4 md:mt-0">
            <div class="inline-flex rounded-md shadow-sm bg-gray-700 p-1">
                <button
                    wire:click="changeTimeRange('daily')"
                    type="button"
                    class="px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 {{ $timeRange === 'daily' ? 'bg-indigo-600 text-white' : 'bg-transparent text-gray-300 hover:text-white hover:bg-gray-600' }}"
                >
                    Daily
                </button>
                <button
                    ...
                    type="button"
                    class="px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 {{ $timeRange === 'weekly' ? 'bg-indigo-600 text-white' : 'bg-transparent text-gray-300 hover:text-white hover:bg-gray-600' }}"
                >
                    Weekly
                </button>
                <button
                    ...
                    type="button"
                    class="px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 {{ $timeRange === 'monthly' ? 'bg-indigo-600 text-white' : 'bg-transparent text-gray-300 hover:text-white hover:bg-gray-600' }}"
                >
                    Monthly
                </button>
                <button
                    wire:click="changeTimeRange('yearly')"
                    type="button"
                    class="px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 {{ $timeRange === 'yearly' ? 'bg-indigo-600 text-white' : 'bg-transparent text-gray-300 hover:text-white hover:bg-gray-600' }}"
                >
                    Yearly
                </button>
            </div>
