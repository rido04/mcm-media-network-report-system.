<footer class="bottom-0 bg-gradient-to-t from-gray-600 to-slate-900 text-white pt-16 pb-8 relative overflow-hidden transition-all duration-1000 ease-out transform opacity-0 translate-y-4"
    ...
    <div class="absolute inset-0 opacity-10">
        <div class="absolute top-0 left-0 w-64 h-64 bg-blue-500 rounded-full mix-blend-overlay filter blur-3xl"></div>
        <div class="absolute bottom-0 right-0 w-64 h-64 bg-purple-500 rounded-full mix-blend-overlay filter blur-3xl"></div>
    </div>
        ...
        <div class="flex flex-col lg:flex-row justify-between">
            ...
            <div class="lg:w-1/3 space-y-6">
                ...
                <p class="text-gray-300 leading-relaxed">
                    Transforming media experiences through innovative digital solutions and strategic partnerships.
                </p>
                <div class="flex space-x-4">
                    <a href="https://www.instagram.com/mcmmedianetworks/" class="text-gray-300 hover:text-rose-700 transition-colors duration-300">
                    ...
                    <a href="#" class="text-gray-300 hover:text-blue-800 transition-colors duration-300">
                        <span class="sr-only">Facebook</span>
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
                        </svg>
                    </a>
                    <a href="https://www.youtube.com/channel/UCsed9VZBgrP6FEvlSgYF0-Q" class="text-gray-300 hover:text-red-700 transition-colors duration-300">
                        <span class="sr-only">YouTube</span>
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M21.582,6.186c-0.23-0.86-0.908-1.538-1.768-1.768C18.254,4,12,4,12,4S5.746,4,4.186,4.418 c-0.86,0.23-1.538,0.908-1.768,1.768C2,7.746,2,12,2,12s0,4.254,0.418,5.814c0.23,0.86,0.908,1.538,1.768,1.768 C5.746,20,12,20,12,20s6.254,0,7.814-0.418c0.861-0.23,1.538-0.908,1.768-1.768C22,16.254,22,12,22,12S22,7.746,21.582,6.186z M10,15.464V8.536L16,12L10,15.464z" clip-rule="evenodd"></path>
                        </svg>
                    </a>
                </div>
            </div>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-sm text-gray-400 text-center md:text-left">
                    Copyright © {{ date('Y') }} · MCMMedianetworks | PT. Maxima Cipta Miliardatha
                </p>
                <p class="text-sm text-gray-400 mt-2 md:mt-0">
                    Developed by <span class="text-blue-400">Digital MCMMedianetworks Division</span>
                </p>
            </div>
        </div>
    </div>
    ...
    <!-- Back to top button -->
    <button id="back-to-top" class="z-50 fixed bottom-8 right-8 bg-blue-600 hover:bg-blue-700 rounded-full p-3 shadow-lg transition-all duration-300 opacity-0 invisible transform translate-y-4">
